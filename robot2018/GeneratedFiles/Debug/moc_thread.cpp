...
void Thread2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread2::sendData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Thread3::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_Thread3.data,
      qt_meta_data_Thread3,  qt_static_metacall, nullptr, nullptr}
};
